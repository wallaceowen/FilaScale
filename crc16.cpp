...
***********************************************************************
*
* Purpose:	adds present unsigned char to a crc-16 value being calculated for file
*		
* Algorithm:	
*
*  The CRC algorithm is based upon algorithms in the public domain.
*  The following comments are by the originator:
*
*  CRCC -- C subroutine to calcute CRC-16 of string of unsigned char using
*  unsigned char-wise method described in June 1983 IEEE Micro.  Uses crctab
